...
class SessionManager : public QObject {
 ...
 public:
  explicit SessionManager(AuthManager *auth, VehicleManager *vehicles, MqttController *mqtt,
 ...
 private:
  ...
  SafetyMonitorService *m_safetyMonitor = nullptr;
  bool m_hadSuccessfulLogin = false;
  QString m_selectedVin;  // 与当前选车/会话一致；onSessionCreated 用后端 sessionVin 覆盖
