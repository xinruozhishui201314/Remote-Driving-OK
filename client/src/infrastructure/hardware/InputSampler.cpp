...
InputSampler::InputSampler(QObject* parent)
    : QObject(parent)
{}
...
void InputSampler::setDevice(std::shared_ptr<IInputDevice> device)
{
...
void InputSampler::start(uint32_t sampleRateHz)
{
    ...
    connect(m_timer, &QTimer::timeout, this, &InputSampler::onTimer,
            Qt::DirectConnection);
    connect(m_samplerThread, &QThread::started, m_timer,
