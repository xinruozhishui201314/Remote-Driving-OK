...
QString KeystoreManager::getFromQtSecure(const QString& key) const
{
    return getFromQSettings(key);
}

bool KeystoreManager::deleteFromQtSecure(const QString& key)
{
    return deleteFromQSettings(key);
}
