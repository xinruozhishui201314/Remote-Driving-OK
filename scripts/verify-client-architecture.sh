...
check "WebRTCChannel"             "src/adapters/network/WebRTCChannel.h"
check "UDPChannel"                "src/adapters/network/UDPChannel.h"
...
check "KeyboardMouseInput"        "src/adapters/hardware/KeyboardMouseInput.h"
